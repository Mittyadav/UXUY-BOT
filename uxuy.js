...
async function main() {
  console.log(colors.yellow(" This Tool Is Developed By Satyam Please Suppot Join Our Channel (https://t.me/CryptoSatyam1)"));
  ...
  while (true) {
    ...
    console.log(`Complete all accounts | Waiting ${settings.TIME_SLEEP} minutes=============`.magenta);
